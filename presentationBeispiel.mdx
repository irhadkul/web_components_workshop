...
ES 9, auch ECMAScript 2018 genannt, im Jahr 2018](./adesso/images/ESHistory.png)
...
![TypeScript ist eine Übermenge von JavaScript.
  ...
  ist ein zweiter Kreis mit der Bezeichnung ES2018. Ein dritter Kreis mit der Bezeichnung TypeScript umschließt die beiden.](./adesso/images/tssuperset.png)
...
interface yDimension {
  y: number;
}
interface zDimension {
  z: number;
}
