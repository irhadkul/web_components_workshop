...
## Irhad Kulanic - Software Engineer @ adesso AG
...
<Section bgSrc="./adesso/images/dayssincelastjsframework.png" logo="white"></Section>
  ...
  dangerouslySetInnerHTML={{
    __html: `
      <video
        ...
        controls
        muted
        src="./adesso/images/image_attribute_change_video.mkv"
      />
    `,
  }}
/>
