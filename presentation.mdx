...
# Übung #1
##### Unser ziel ist es eigenes Custom Element zu bauen. Der soll als eine Visitenkarte aussehen, d.h. es sollen Infos über eine Person dargestellt werden und dazu entsprechend das Bild. Müsterbilder finden Sie unter "uebungen/global/images";

###### DW Visitenkarte Beispiel:
...
1. Definiere ein eigenes "custom" HTML Tag (**dw-contact-card**) in "uebungen/Uebung_1-customElements/index.html"
2. Kreiere ein Custom Element Objekt in JS
3. Wenn initialisiert, es soll zwei Kind-elemente deffinieren:
- das Bild und es entsprechend mit "src" ausstatten 
- Absatz oder "p" Element und ihm mit z.B. eigene Name rendern

##### *Um Elemente in JS zu definieren kann man z.B. "document.createElement('p')" benutzen* 
...
# Shadow DOM  
  ...
  - document.querySelector auf Document Ebene gibt den Elementen aus Shadow DOM nicht als Ergebnis 
...
- Bild und Absatz Elemente in Übung #1 definiert jetzt in Shadow DOM rendern
##### Notiz: Element soll nicht entsprechend gut aussehen. Wir werden das in Übung 3 korrigieren
...
- Die Styles definiert außerhalb der Shadow DOM, haben keinen Einfluss auf Elementen die sich in Shadow DOM befinden. 
