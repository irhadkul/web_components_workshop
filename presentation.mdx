...
Die Visitenkarte soll einen Namen und eines der mitgelieferten Bilder anzeigen.
Als Einstiegspunkt für die Übung nutzt bitte die Datei `Uebung_1-CustomElements/index.js`. 
In dieser Datei ist auch eine kleine Anleitung in Form von TODOs hinterlegt.
...
In dieser Übung wollen wir uns mit Templates befassen. Lagert alle Kindelemente aus der `MyContractCard`
...
soll an der Stelle des Standardtextes unter dem `.details`-Container erscheinen.
...
# Properties, Events und Callbacks
## Übung 6
