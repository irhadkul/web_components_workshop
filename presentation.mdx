...
- Standardiziertes Weg um eigene HTML Elemente zu definieren und erweitern
...
- Erste Version in 2014, Google Chrome (V0)
...
- HTML Modules sind noch nicht LS. Nachvolger von HTML Imports
...
# Specifications
- 4 Verschiedene Technologien die von unterschidliche Arbeitsgruppen entwicklet sind
- 3 davon Living Standard und unterstuzt von vielen Browsers
...
- Built-in Elements bieten uns begränztes Erweiterungsmöglichkeit
...
# Implementation bestehende Komponetnen 
- um bestehende Komponenenten zu importieren hat man mehrere Möglichkeiten:
